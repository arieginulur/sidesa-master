<?php 
    ...
    $getidlahir = mysqli_query($conn, "SELECT MAX(id_keluarga) id_keluarga FROM tbl_keluarga");
    ...
    //Tabel lahir
    $insertlahir = mysqli_query($conn,"INSERT INTO tbl_keluarga (id_keluarga,id_penduduk,no_kk,alamat,rt,rw) 
    ...
    if($insertlahir){
        ...
        if($insertpenduduk){
            header("Location: ../meninggal_tambah?success");
            exit();
        } else {
            header("Location: ../meninggal_tambah?success");
            exit();
