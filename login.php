...
<form action="validasi" method="POST">
  ...
  <button type="submit"  name="login_warga" class="btn btn-success " id="login">Login</button>
...
<?php endif; ?>
  ...
  <center><p class="lgn">Belum Punya Akun? Daftar<a href="registrasi.php" >Disini</p></a></center>
</div>
</div>
</div>
