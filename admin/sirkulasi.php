        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-users"></i> &nbsp;&nbsp;Sirkulasi Penduduk</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active">Sirkulasi Penduduk</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            while($data = mysqli_fetch_array($query)){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="sirkulasi_edit?id1=<?php echo $data["id_penduduk"] ?>&id2=<?php echo $data["id_keluarga"] ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                                        <a href="sirkulasi_hapus?id1=<?php echo $data["id_penduduk"] ?>&id2=<?php echo $data["id_keluarga"] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
