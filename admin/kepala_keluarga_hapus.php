...
<html lang="en">
<head>
    <title>Edit Kepala Keluarga</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-danger">
                                    <h3 class="card-title">Hapus Keluarga</h3>
                                </div>
                                <div class="card-body">
                                    <?php 
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                            <label>Apakah Anda ingin menghapus Data Keluarga di atas ?</label>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <form action="module/kepala_keluarga_delete" method="post">
                                            <?php 
                                                $idpenduduk = $_GET["id1"];
                                                $idkeluarga = $_GET["id2"];
                                            ?>
