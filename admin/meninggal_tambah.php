                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <li class="breadcrumb-item"><a href="meninggal">Data Penduduk</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <form action="module/meninggal_insert" method="post">
                                    ...
                                    <hr>
                                        ...
                                        <button type="upload" class="btn btn-danger">UPLOAD AKTA MENINGGAL</button>
                                </div>
                                <div class="card-footer">
                                    <a href="meninggal" class="btn btn-default"><i class="fas fa-arrow-left"></i> Kembali</a>
